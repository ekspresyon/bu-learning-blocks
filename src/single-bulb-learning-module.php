...
?>
			...
			<?php while ( have_posts() ) : 
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'content_area' ); ?>>
					<header class="bulb-entry-header">
							<?php
								the_title( '<h1 class="entry-title bulb-entry-title">', '</h1>' );
							?>
					</header><!-- .entry-header -->
					<div class="bulb-content">
						<div class="bulb-entry-content">
							<?php the_content(); ?>
			...
			?>
						...
						<div class="bulb-pagination bulb-pagination-clearfix">
